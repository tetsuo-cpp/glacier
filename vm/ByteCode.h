...
#define GLC_BYTECODE_MAP_ACCESS 0x1C
#define GLC_BYTECODE_VEC_PUSH 0x1D
#define GLC_BYTECODE_VEC_LEN 0x1E
#define GLC_BYTECODE_VEC_POP 0x1F
#define GLC_BYTECODE_MAP_INSERT 0x20
